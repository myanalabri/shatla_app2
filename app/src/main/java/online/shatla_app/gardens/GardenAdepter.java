...
public class GardenAdepter extends RecyclerView.Adapter<GardenAdepter.MyViewHolder> {

    private ArrayList<GardenItem> dataSet;
    ...
    public GardenAdepter(ArrayList<GardenItem> dataSet, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.garden_activity,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        GardenItem items =dataSet.get(position);
