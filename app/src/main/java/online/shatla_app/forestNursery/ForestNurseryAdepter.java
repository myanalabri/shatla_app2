...
public class ForestNurseryAdepter extends RecyclerView.Adapter<ForestNurseryAdepter.MyViewHolder> {

    private ArrayList<ForestNurseryItem> dataSet;
    ...
    public ForestNurseryAdepter(ArrayList<ForestNurseryItem> dataSet, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.forest_nursery_adpter,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ForestNurseryItem items =dataSet.get(position);
