...
public class ToolAdepter extends RecyclerView.Adapter<ToolAdepter.MyViewHolder> {

    private ArrayList<ToolItem> dataSet;
    ...
    public ToolAdepter(ArrayList<ToolItem> dataSet, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.activity_tool,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ToolItem items =dataSet.get(position);
