...
public class FruitNurseryAdepter extends RecyclerView.Adapter<FruitNurseryAdepter.MyViewHolder> {

    private ArrayList<FruitNurseryItem> dataSet;
    ...
    public FruitNurseryAdepter(ArrayList<FruitNurseryItem> dataSet, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.activity_fruit_nursery_adepter,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        FruitNurseryItem items =dataSet.get(position);
