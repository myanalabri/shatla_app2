...
public class OrnamentalNurseryAdepter extends RecyclerView.Adapter<OrnamentalNurseryAdepter.MyViewHolder> {

    private ArrayList<OrnamentalNurseryItem> dataSet;
    ...
    public OrnamentalNurseryAdepter(ArrayList<OrnamentalNurseryItem> dataSet, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.ornamental_nursery_adepter,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        OrnamentalNurseryItem items =dataSet.get(position);
